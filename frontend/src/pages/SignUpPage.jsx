                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        <div className='form-control'>
                            ...
                            <div className='relative'>
                                ...
                                <input
                                    type="text"
                                    className={`input focus:outline-none focus:ring-0 focus:ring-offset-0 focus:duration-200 focus:border-primary input-bordered w-full pl-10`}
                        ...
                        <div className='form-control'>
                            ...
                            <div className='relative'>
                                ...
                                <button
                                    type='button'
                                    className='absolute cursor-pointer inset-y-0 z-10 right-0 pr-3 flex items-center'
